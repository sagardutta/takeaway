...
//                Note note4 = new Note(text:"note4",course:marketing, session: session2, user:user1).save();
//                Note note5 = new Note(text:"note5",course:marketing, session: session2, user:user2).save();
//                Note note6 = new Note(text:"note6",course:marketing, session: session2, user:user3).save();
