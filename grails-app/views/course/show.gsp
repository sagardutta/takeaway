	...
	<body>
		...
		<div id="show-course" class="content scaffold-show" role="main">
			...
			<ol class="property-list course">
				...
				<li class="fieldcontain">
					<span id="professor-label" class="property-label"><g:message code="course.professor.label" default="Professor" /></span>
					
						<span class="property-value" aria-labelledby="professor-label"><g:fieldValue bean="${courseInstance}" field="professor"/></span>
				...
				<li class="fieldcontain">
					<span id="sessions-label" class="property-label"><g:message code="course.sessions.label" default="Sessions" /></span>
